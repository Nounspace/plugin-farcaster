...
import { Cast, Profile } from '../common/types';
...
export class FarcasterStreamSource extends FarcasterInteractionSource {
    ...
    async start(): Promise<void> {
        ...
        // The gRPC client expects a hostname without a protocol prefix.
    ...
    private async handleStreamError(error: Error): Promise<void> {
        logger.error('Farcaster: Stream error details:', JSON.stringify({
